...
public class SmsUtils
{
	...
	public static String sendSms(String smshost, String secret, String appid,
			String mobile, String text)
	{
		String[][] kvs = new String[][] {
				new String[] { "message", text },
				new String[] { "mobile", mobile },
				new String[] { "nsp_app", appid },
				new String[] { "nsp_fmt", "JSON" },
				new String[] { "nsp_svc", "nsp.sms.send" },
				new String[] { "nsp_ts",
		...
		try
		{
			...
			StringBuffer urlstr = new StringBuffer(smshost).append("?nsp_key=")
					.append(hex);
	...
	public static String sendMail(String smshost, String secret, String appid,
			String mailto, String title, String text)
			throws NoSuchAlgorithmException, UnsupportedEncodingException,
			MalformedURLException, IOException
	{
		String[][] kvs = new String[][] {
				new String[] { "subject", title },
				new String[] { "body", text },
				new String[] { "nsp_app", appid },
				new String[] { "nsp_fmt", "JSON" },
				new String[] { "nsp_svc", "nsp.mail" },
				new String[] { "nsp_ts",
						String.valueOf(new Date().getTime() / 1000) },
				new String[] { "nsp_ver", "1.0" },
				new String[] { "reciver", mailto } };
